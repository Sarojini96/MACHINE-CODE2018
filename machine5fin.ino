...
void httpRequest()
{
  ...
  if (client.connect(server, 8081)) {
    ...
    if ((onpin == 1 ) && (onstatus == 0))
    {
      onstatus = 1;
      offstatus = 1;
      client.println(String("GET /ONFV HTTP/1.1"));
      Serial.print("on");
      // gv1=1;
    }
    /*  if(gv==1)
    ...
    if ((onpin == 0) && (onstatus == 1))
    {
      offstatus = 0;
      onstatus = 0;
      client.println(String("GET /OFFFV HTTP/1.1"));
      Serial.print("off");
      //gv =1;
    }
    /*  if(var1==1)
...
//       }*/
    ...
    if ((problempin == 1) && ( probstatus == 0))
    {
      probstatus = 1;
      probsolvedstatus = 1;
      client.println(String("GET /PROBLEMFV HTTP/1.1"));
    ...
    if ((problempin == 0) && (probstatus == 1))
    {
      probsolvedstatus = 0;
      probstatus = 0;
      client.println(String("GET /PROBLEMSOLVEDFV HTTP/1.1"));
      Serial.print("off");
      //  rv =1;
    }
    if ((idlepin == 1) && (idlestatus == 0))
    {
      idlestatus = 1;
      idleoffstatus = 1;
      client.println(String("GET /IDLEFV HTTP/1.1"));
      Serial.print("idle");
      //  rv =1;
    }
    if ((idlepin == 0) && ( idlestatus == 1))
    {
      idleoffstatus = 0;
      idlestatus = 0;
      client.println(String("GET /IDLEOFFFV HTTP/1.1"));
