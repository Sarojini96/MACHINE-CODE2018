...
void httpRequest()
{
  ...
  int onpinS = digitalRead(7);
  int problempinS = digitalRead(8);
  int idlepinS = digitalRead(9);
  Serial.println("onpin=" + String(onpinS) + "probpin=" + String(problempinS) + "idlepin=" + String(idlepinS));
